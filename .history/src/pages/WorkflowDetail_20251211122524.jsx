...
/**
 * MediaRenderer: converts common share links to embed/direct links and renders them.
 * Supports YouTube (watch/youtu.be/embed), Vimeo, Dropbox, Google Drive, and mp4/webm.
 */
