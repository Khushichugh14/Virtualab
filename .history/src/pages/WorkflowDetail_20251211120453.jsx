    ...
    <main className="px-6 pt-28 pb-12">
      <div className="max-w-6xl mx-auto">
        ...
        <p className="text-neutral-400 max-w-2xl mb-8">
          How your team goes from idea → code → production.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {workflow.map((w) => (
            <div
              key={w.id}
              className="p-6 bg-neutral-900 rounded-xl border border-neutral-800 hover:shadow-lg transition h-full flex flex-col"
            >
              ...
              <p className="text-neutral-400 mb-4 flex-1">{w.short}</p>
