...
const SESSION_KEY = "virtualrSession"; // ✅ same as SignIn / CreateAccount
...
const Navbar = () => {
  ...
  const handleLogout = () => {
    localStorage.removeItem(SESSION_KEY); // clear current session
    setIsLoggedIn(false);
    navigate("/create-account"); // ✅ go to SIGN-UP page after logout
  };
