...
const testimonials = [
  {
    ...
    rating: 5,
    feedback:
      "The platform reduced our onboarding time by 40%. Collaboration is seamless and incredibly intuitive.",
  },
  {
    name: "Ravi P.",
    role: "CTO, Buildify",
    ...
    rating: 5,
    feedback:
      "One-click deploy saved our team hours every week. The realtime editor transformed how we collaborate.",
  },
  {
    name: "Neha S.",
    role: "Product Manager, FlowOps",
    img: "https://randomuser.me/api/portraits/women/12.jpg",
    rating: 4,
    feedback:
      "The analytics dashboard gave us crystal-clear insights. Our workflow has never been this smooth.",
  },
  {
    name: "Arjun V.",
    role: "DevOps Engineer, CloudNext",
    img: "https://randomuser.me/api/portraits/men/55.jpg",
    rating: 5,
    feedback:
      "Seamless CI/CD integration. Our deployment frequency doubled after switching.",
  },
  {
    name: "Mira T.",
    ...
    rating: 5,
    feedback:
      "The AI automation alone is worth it. Reduced manual tasks by more than 60%.",
  },
];
