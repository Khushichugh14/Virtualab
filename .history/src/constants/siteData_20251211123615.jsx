...
// paste into src/constants/siteData.js (replace previous workflow entries)
...
velocity. Dependencies should be identified early to prevent bottlenecks.`,
    ...
    video: "https://www.youtube.com/watch?v=W10CVrvX4so",
    icon: "⏱️",
  },

  // DEVELOP (rich data + working video)
  {
    id: "develop",
    title: "Develop",
...
• Fast, helpful CI feedback with clear failure messages and logs so developers fix issues quickly.`,
    ...
    // working YouTube embed (use embed format)
    video: "https://www.youtube.com/watch?v=vwT5Tun61hI",
    icon: "💻",
  },

  // RELEASE (rich data + working video)
  {
    id: "release",
    title: "Release",
...
• Automate rollback triggers for health-check failures to reduce MTTR.`,
    ...
    video: "https://www.youtube.com/watch?v=A1E6P7U_nrk",
    icon: "🚀",
  }
];
